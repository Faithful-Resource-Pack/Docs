...
<img class="center" src="/images/dungeons/items-tutorial/header.png" alt="header" loading="lazy">
...
<h3>Blockbench:</h3>
<img class="center" src="/images/dungeons/items-tutorial/hotkey_blockbench.png" alt="hotkey blockbench" loading="lazy">
<h3>Blender:</h3>
<img class="center" src="/images/dungeons/items-tutorial/hotkey_blender.png" alt="hotkey blender" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/no-3rd-mouse-emulation-1.png" alt="no 3rd mouse emulation 1" loading="lazy">

2. In that window, go to the Input tab and check the `Emulate 3 Button Mouse` and `Emulate Numpad` boxes.
<img class="center" src="/images/dungeons/items-tutorial/no-3rd-mouse-emulation-2.png" alt="no 3rd mouse emulation 2" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/hotkey_mac.png" alt="hotkey mac" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/prepare-a-texture-1.png" alt="prepare a texture 1" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/prepare-a-texture-2.png" alt="prepare a texture 2" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/extrude-texture-1.png" alt="extrude texture 1" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/extrude-texture-2.png" alt="extrude texture 2" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/extrude-texture-3.png" alt="extrude texture 3" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/extrude-texture-4.png" alt="extrude texture 4" loading="lazy">

Now move the model so that it's centered on the grid.

<img class="center" src="/images/dungeons/items-tutorial/extrude-texture-5.png" alt="extrude texture 5" loading="lazy">

Finally, right click on the texture under the Textures tab, and then change the file to your original, unmodified texture.

<img class="center" src="/images/dungeons/items-tutorial/extrude-texture-6.png" alt="extrude texture 6" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/export-as-obj.png" alt="export as obj" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/import-model-to-blender-1.png" alt="import model to blender 1" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/import-model-to-blender-2.png" alt="import model to blender 2" loading="lazy">

Your model should then look something like this:

<img class="center" src="/images/dungeons/items-tutorial/import-model-to-blender-3.png" alt="import model to blender 3" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/import-model-to-blender-4.png" alt="import model to blender 4" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/set-up-a-material-1.png" alt="set up a material 1" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/set-up-a-material-2.png" alt="set up a material 2" loading="lazy">

Next, copy the name into this field at the top of the Material Properties tab, and press Enter.

<img class="center" src="/images/dungeons/items-tutorial/set-up-a-material-3.png" alt="set up a material 3" loading="lazy">

Now you can fix the texture filtering by going into this dropdown menu and selecting Closest.

<img class="center" src="/images/dungeons/items-tutorial/set-up-a-material-4.png" alt="set up a material 4" loading="lazy">

If you've done everything correctly, your model should look roughly like this:

<img class="center" src="/images/dungeons/items-tutorial/set-up-a-material-5.png" alt="set up a material 5" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/position-and-scale-1.png" alt="position and scale 1" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/position-and-scale-2.png" alt="position and scale 2" loading="lazy">

Now you can import the default model by going to File > Import, selecting Skeleton mesh (.psk) and navigating to the model.

<img class="center" src="/images/dungeons/items-tutorial/position-and-scale-3.png" alt="position and scale 3" loading="lazy">

Now that you've imported the model you can scale, move and rotate your custom one to fit the default like so:

<img class="center" src="/images/dungeons/items-tutorial/position-and-scale-4.png" alt="position and scale 4" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/position-and-scale-5.png" alt="position and scale 5" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/export-as-fbx-1.png" alt="export as fbx 1" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/export-as-fbx-2.png" alt="export as fbx 2" loading="lazy">

Next, look at the model's name in the default game files and name your model that.

<img class="center" src="/images/dungeons/items-tutorial/export-as-fbx-3.png" alt="export as fbx 3" loading="lazy">

Finally, click the blue Export button to finish the process.

<img class="center" src="/images/dungeons/items-tutorial/export-as-fbx-4.png" alt="export as fbx 4" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/rendering-import-model-1.png" alt="rendering import model 1" loading="lazy">

When you've installed the add-on, make sure it's enabled by ticking the box below in the Add-ons tab and checking if the add-on is present in the list. (if it's not, untick the box, find the add-on and enable it manually.)

<img class="center" src="/images/dungeons/items-tutorial/rendering-import-model-2.png" alt="rendering import model 2" loading="lazy">

Now you can import the default model by going to File > Import, selecting Skeleton mesh (.psk) and navigating to the model.

<img class="center" src="/images/dungeons/items-tutorial/rendering-import-model-3.png" alt="rendering import model 3" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/set-up-a-material-again-1.png" alt="set up a material again 1" loading="lazy">

Then switch to the Shader Editor using this menu up top:

<img class="center" src="/images/dungeons/items-tutorial/set-up-a-material-again-2.png" alt="set up a material again 2" loading="lazy">

The tab should change into a node editor. Enlarge it so you can see it better and then make it look like this:

<img class="center" src="/images/dungeons/items-tutorial/set-up-a-material-again-3.png" alt="set up a material again 3" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/set-up-a-material-again-4.png" alt="set up a material again 4" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/add-a-light-1.png" alt="add a light 1" loading="lazy">

Before adding a light, switch to Render mode (the third circle in the top right menu) to see the changes properly.

<img class="center" src="/images/dungeons/items-tutorial/add-a-light-2.png" alt="add a light 2" loading="lazy">

Now you can add a light by pressing Shift + A while hovering above the model view, going to Light and selecting Sun.

<img class="center" src="/images/dungeons/items-tutorial/add-a-light-3.png" alt="add a light 3" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/add-a-light-4.png" alt="add a light 4" loading="lazy">

When you're done you should get something that matches the default view and lightning pretty closely:

<img class="center" src="/images/dungeons/items-tutorial/add-a-light-5.png" alt="add a light 5" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/set-up-a-camera-1.png" alt="set up a camera 1" loading="lazy">

Next, click this little arrow next to the axis cross thing:

<img class="center" src="/images/dungeons/items-tutorial/set-up-a-camera-2.png" alt="set up a camera 2" loading="lazy">

A menu should pop up. Open the View tab and check the Lock Camera to View box.

<img class="center" src="/images/dungeons/items-tutorial/set-up-a-camera-3.png" alt="set up a camera 3" loading="lazy">

Next, select a camera that should already be placed somewhere in your project. It should look like this:

<img class="center" src="/images/dungeons/items-tutorial/set-up-a-camera-4.png" alt="set up a camera 4" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/set-up-a-camera-5.png" alt="set up a camera 5" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/configure-and-render-1.png" alt="configure and render 1" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/configure-and-render-2.png" alt="configure and render 2" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/configure-and-render-3.png" alt="configure and render 3" loading="lazy">
...
<img class="center" src="/images/dungeons/items-tutorial/configure-and-render-4.png" alt="configure and render 4" loading="lazy">

And there you have it! You have made yourself a model and render that is usable in Minecraft: Dungeons!

<img class="center" src="/images/dungeons/items-tutorial/configure-and-render-5.png" alt="configure and render 5" loading="lazy">
