...
# Punishment Guidelines / Rule Elaborations / Punishment Appeals
...
<p>
    <i>
    As long as the Faithful Discord servers have existed, there have been one set of rules, with a description of what not to do, and nothing more. While this sounds pretty standard for most Discord servers at first, the problem was that the interpretation of these rules was entirely up the moderator who was online at the time. 
    <br><br>
    This system resulted in a plethora of hasty decisions made on the spot that would oftentimes be regretted a few hours later when more people had communicated their thoughts and feelings. In addition, there was little to no transparency as to how decisions were made, resulting in the alienation of the community from the moderation staff. Users would seemingly get punished for no reason after just making a joke, and the moderation team wouldn't give any insight as to why. 
    <br><br>
    This is one of many steps we are taking to show the normal user our thought process as to how, when, and why we punish users, by providing a comprehensive list of every point of every rule with punishments attached. We are also introducing a punishment appeal system so any hasty decisions made in the past can be revisited with our new ideology.
    <br><br>
    With all that out of the way, here's some basic definitions.
    </i>
</p>
...
<ol>
    ...
    <ol class="lettered">
        <li>Depends on the damage dealt, but in general harsher punishments are used.</li>
    </ol>
    <br>
    ...
    <ol class="lettered">
        <li>If it is used as hyperbole/not seriously, verbally warn the user that these terms are not allowed and delete the messages in question, for repeated offenses ban the user.</li>
    ...
    <br>
    <li><b>Spreading misinformation</b> is when a user tntentionally makes up or mixes up information for the purposes of creating a reaction.</li>
     <ol class="lettered">
...
<ol>
    <li><b>NSFW / NSFL content</b> - This is literally a Minecraft server, post that sort of thing elsewhere. Examples can be found directly above in the rule description, just use common sense and you'll be fine.</li>
    <ol class="lettered">
