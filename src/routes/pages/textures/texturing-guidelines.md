...
<ul>
  <li><a href="asdfasdf2#introduction">Introduction</a></li>
  <li><a href="asdfasdf2#part-1-terms-and-definitions">Part 1: Terms and Definitions</a></li>
  <ol>
    <li><a href="asdfasdf2#blending">(Colour) Blending</a></li>
    <ol class="lettered">
      <li><a href="asdfasdf2#no-blending">No Blending</a></li>
      <li><a href="asdfasdf2#anti-aliasing">Anti-Aliasing (AA)</a></li>
      <li><a href="asdfasdf2#dithering">Dithering</a></li>
      <ol class="roman">
        <li><a href="asdfasdf2#checkerboard-dithering">Checkerboard dithering</a></li>
        <li><a href="asdfasdf2#regular-dithering">Regular dithering</a></li>
        <li><a href="asdfasdf2#linear-dithering">Linear dithering</a></li>
      </ol>
      <li><a href="asdfasdf2#colour-banding">Colour Banding</a></li>
    </ol>
    <li><a href="asdfasdf2#indexing-colours">Indexing Colours</a></li>
    <li><a href="asdfasdf2#upscaling-a-texture">Upscaling</a></li>
    <li><a href="asdfasdf2#jappa">JAPPA</a></li>
    <li><a href="asdfasdf2#prog-art">Programmer Art</a></li>
    <li><a href="asdfasdf2#jappa-textures">JAPPA Textures</a></li>
    <li><a href="asdfasdf2#false-lines">False Lines</a></li>
    <li><a href="asdfasdf2#mixels">Mixels</a></li>
    <li><a href="asdfasdf2#contrast-palette">Contrast</a></li>
  </ol>
  <li><a href="asdfasdf2#part-2-general-rules-and-tips">Part 2: General Rules and Tips</a></li>
  <ol>
    Rules
    <li><a href="asdfasdf2#mimic-vanilla">Mimic Vanilla Textures</a></li>
    <li><a href="asdfasdf2#1px-wide">One Pixel Lines</a></li>
    <li><a href="asdfasdf2#shading">Shading</a></li>
    <li><a href="asdfasdf2#meaning">Meaning</a></li>
    <li><a href="asdfasdf2#vanilla-colour-palette">Vanilla Colour Palette</a></li>
    <li><a href="asdfasdf2#too-much-details">Details</a></li>
    <li><a href="asdfasdf2#blending-colours">Blending Colours</a></li>
    <li><a href="asdfasdf2#erase-colour-banding">Colour Banding</a></li>
    <li><a href="asdfasdf2#no-colour-chunk">No Large Single-Colour Areas</a></li>
    <li><a href="asdfasdf2#other-texture-as-base">Use Existing Textures as a Base</a></li>
    <li><a href="asdfasdf2#identical-when-upscaled">Exact when upscaled</a></li>
    <li><a href="asdfasdf2#bugs-in-textures">Bugs</a></li>
  </ol>
  <ol>
    Tips
    <li><a href="asdfasdf2#mob-faces">Mob Faces</a></li>
    <li><a href="asdfasdf2#dithering-tip">Dithering</a></li>
    <li><a href="asdfasdf2#stairing-pixels">Stairing Pixels</a></li>
  </ol>
  <li><a href="asdfasdf2#part-3-material-and-shape-reference-list">Part 3: Material and Shape Reference List</a></li>
  <ul>
    Materials
    <li><a href="asdfasdf2#smooth-metal">Smooth Metal</a></li>
    <li><a href="asdfasdf2#rought-metal">Rough Metal</a></li>
    <li><a href="asdfasdf2#gems">Gemstones</a></li>
    <li><a href="asdfasdf2#contiguous-stones">Contiguous Stones</a></li>
    <li><a href="asdfasdf2#polished-stones">Polished Stones</a></li>
    <li><a href="asdfasdf2#rocky-materials">Rocky Materials</a></li>
    <li><a href="asdfasdf2#wood">Wood</a></li>
    <li><a href="asdfasdf2#flowers">Flowers</a></li>
    <li><a href="asdfasdf2#corals">Corals</a></li>
    <li><a href="asdfasdf2#sands">Sand & Powder</a></li>
    <li><a href="asdfasdf2#bee-nests">Bee Nests</a></li>
    <li><a href="asdfasdf2#honey">Honey & Slime</a></li>
    <li><a href="asdfasdf2#terracotta">Glazed Terracotta</a></li>
    <li><a href="asdfasdf2#glass">Glass</a></li>
    <li><a href="asdfasdf2#bones">Bones</a></li>
    <li><a href="asdfasdf2#cloth-paper">Cloth & Paper</a></li>
    <li><a href="asdfasdf2#skin">Skin</a></li>
    <li><a href="asdfasdf2#creepers">Creepers</a></li>
    <li><a href="asdfasdf2#fur-hair">Fur & Hair</a></li>
    <li><a href="asdfasdf2#fish">Fish Entity</a></li>
    Shapes
    <li><a href="asdfasdf2#cylinders">Cylinders</a></li>

  </ul>
  <li><a href="asdfasdf2#part-4-fixing-jappas-mistakes-and-things-hes-forgotten">Part 4: Fixing Jappa’s Mistakes and Things He’s Forgotten</a></li>
  <li><a href="asdfasdf2#conclusion">Conclusion</a></li>
  <li><a href="asdfasdf2#final-note">Final Note</a></li>
  <li><a href="asdfasdf2#credits">Credits</a></li>
</ul>
</div>
___
...
<ol>
  ...
  <ol class="lettered">
    ...
    <br>
    <img src="asdfasdf/images/pages/textures/1.png" alt="no blending" class="center" loading="lazy">
    ...
    <br>
    <img src="asdfasdf/images/pages/textures/2.png" alt="aliased and anti-aliased" class="center" loading="lazy">
    <p class="center"><i><b>Picture 2:</b> A line with no anti-aliasing compared to a line with anti-aliasing applied to it.</i></p>
    <img src="asdfasdf/images/pages/textures/3.png" alt="anti-aliasing" class="center" loading="lazy">
    <img src="asdfasdf/images/pages/textures/4.png" alt="anti-aliasing" class="center" loading="lazy">
    ...
    <ol class="roman">
      ...
      <br>
      <img src="asdfasdf/images/pages/textures/5.png" alt="checkerboard dithering transition" class="center" loading="lazy">
      <p class="center"><i><b>Picture 4:</b> Checkerboard dithering used as a transition between two colours.</i></p>
      <br>
      <img src="asdfasdf/images/pages/textures/6.png" alt="checkerboard dithering texture" class="center" loading="lazy">
      ...
      <br>
      <img src="asdfasdf/images/pages/textures/7.png" alt="regular dithering texture" class="center" loading="lazy">
      ...
      <br>
      <img src="asdfasdf/images/pages/textures/8.png" alt="linear dithering texture" class="center" loading="lazy">
    ...
    <img src="asdfasdf/images/pages/textures/9.png" alt="mixed dithering textures" class="center" loading="lazy">
    ...
    <br>
    <img src="asdfasdf/images/pages/textures/10.png" alt="colour banding" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/11.png" alt="indexing" class="center" loading="lazy">
  <img src="asdfasdf/images/pages/textures/12.png" alt="indexing" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/13.png" alt="Jappa textures" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/14.png" alt="false lines" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/15.png" alt="mixel texture" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/16.png" alt="false lines" class="center" loading="lazy">
...
<ol>
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/17.png" alt="outlines" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/18.png" alt="shading" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/19.png" alt="correct upscaling" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/20.png" alt="texture details" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/21.png" alt="colour borders" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/22.png" alt="already existing texture" class="center" loading="lazy">
...
<ol>
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/23.png" alt="acceptable mob face" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/24.png" alt="overdone dithering" class="center" loading="lazy">
  ...
  <br>
  <img src="asdfasdf/images/pages/textures/25.png" alt="stairing pixels" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/26.png" alt="smooth metal textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/27.png" alt="rough metal textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/28.png" alt="gemstone textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/29.png" alt="raw stone textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/30.png" alt="polished stone textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/31.png" alt="rocky material textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/32.png" alt="wood textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/33.png" alt="plant textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/34.png" alt="coral textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/35.png" alt="powdery textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/36.png" alt="glazed terracotta textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/37.png" alt="bone textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/38.png" alt="skin textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/39.png" alt="fur/hair textures" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/40.png" alt="fish texture" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/41.png" alt="cylindrical type objects" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/42.png" alt="forgotten texture" class="center" loading="lazy">
...
<img src="asdfasdf/images/pages/textures/43.png" alt="texture should not be jappafied" class="center" loading="lazy">
