...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/header.png" loading="lazy">
...
<ul>
  ...
  <li><a href="asdfasdf2#requirements">Requirements</a></li>
  <li><a href="asdfasdf2#part-0-controls--hotkeys">Part 0: Controls & Hotkeys</a></li>
  <ul>
    <li><a href="asdfasdf2#blockbench">Blockbench</a></li>
    <li><a href="asdfasdf2#blender">Blender</a></li>
    <li><a href="asdfasdf2#-what-if-i-dont-have-a-3rd-button-mousenumpad">No 3rd mouse Numpad</a></li>
  </ul>
  <li><a href="asdfasdf2#part-1-modelling">Part 1: Modelling</a></li>
  <ol class="closing-bracket">
    <li><a href="asdfasdf2#1-prepare-a-texture">Prepare a texture</a></li>
    <li><a href="asdfasdf2#2-extrude-texture-in-blockbench">Extrude texture in Blockbench</a></li>
    <li><a href="asdfasdf2#3-export-the-model-as-obj">Export the model as OBJ</a></li>
    <li><a href="asdfasdf2#4-import-the-model-into-blender">Import the model into Blender</a></li>
    <li><a href="asdfasdf2#5-set-up-a-material">Set up a material</a></li>
    <li><a href="asdfasdf2#6-position-and-scale-your-model">Position & Scale your model</a></li>
    <li><a href="asdfasdf2#7-export-your-model-as-fbx">Export your model as FBX</a></li>
  </ol>
  <li><a href="asdfasdf2#part-2-rendering">Part 2: Rendering</a></li>
  <ol class="closing-bracket">
    <li><a href="asdfasdf2#1-import-your-model">Import your model</a></li>
    <li><a href="asdfasdf2#2-set-up-a-material-again">Set up a material (again)</a></li>
    <li><a href="asdfasdf2#3-add-a-light">Add a light</a></li>
    <li><a href="asdfasdf2#4-set-up-a-camera">Set up a camera</a></li>
    <li><a href="asdfasdf2#5-configure-output-and-render">Configure & Render</a></li>
  </ol>
</ul>
</div>
...
### Blockbench:
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/hotkey_blockbench.png" loading="lazy">
### Blender:
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/hotkey_blender.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/no-3rd-mouse-emulation-1.png" loading="lazy">

2. In that window, go to the Input tab and check the `Emulate 3 Button Mouse` and `Emulate Numpad` boxes.
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/no-3rd-mouse-emulation-2.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/hotkey_mac.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/prepare-a-texture-1.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/prepare-a-texture-2.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/extrude-texture-1.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/extrude-texture-2.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/extrude-texture-3.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/extrude-texture-4.png" loading="lazy">

Now move the model so that it's centered on the grid.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/extrude-texture-5.png" loading="lazy">

Finally, right click on the texture under the Textures tab, and then change the file to your original, unmodified texture.

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/extrude-texture-6.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/export-as-obj.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/import-model-to-blender-1.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/import-model-to-blender-2.png" loading="lazy">

Your model should then look something like this:  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/import-model-to-blender-3.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/import-model-to-blender-4.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-material-1.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-material-2.png" loading="lazy">

Next, copy the name into this field at the top of the Material Properties tab, and press Enter.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-material-3.png" loading="lazy">

Now you can fix the texture filtering by going into this dropdown menu and selecting Closest.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-material-4.png" loading="lazy">

If you've done everything correctly, your model should look roughly like this:  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-material-5.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/position-and-scale-1.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/position-and-scale-2.png" loading="lazy">

Now you can import the default model by going to File > Import, selecting Skeleton mesh (.psk) and navigating to the model.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/position-and-scale-3.png" loading="lazy">

Now that you've imported the model you can scale, move and rotate your custom one to fit the default like so:  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/position-and-scale-4.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/position-and-scale-5.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/export-as-fbx-1.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/export-as-fbx-2.png" loading="lazy">

Next, look at the model's name in the default game files and name your model that.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/export-as-fbx-3.png" loading="lazy">

Finally, click the blue Export button to finish the process.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/export-as-fbx-4.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/rendering-import-model-1.png" loading="lazy">

When you've installed the add-on, make sure it's enabled by ticking the box below in the Add-ons tab and checking if the add-on is present in the list. (if it's not, untick the box, find the add-on and enable it manually.)  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/rendering-import-model-2.png" loading="lazy">

Now you can import the default model by going to File > Import, selecting Skeleton mesh (.psk) and navigating to the model.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/rendering-import-model-3.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-material-again-1.png" loading="lazy">

Then switch to the Shader Editor using this menu up top:  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-material-again-2.png" loading="lazy">

The tab should change into a node editor. Enlarge it so you can see it better and then make it look like this:  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-material-again-3.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-material-again-4.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/add-a-light-1.png" loading="lazy">

Before adding a light, switch to Render mode (the third circle in the top right menu) to see the changes properly.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/add-a-light-2.png" loading="lazy">

Now you can add a light by pressing Shift + A while hovering above the model view, going to Light and selecting Sun.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/add-a-light-3.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/add-a-light-4.png" loading="lazy">

When you're done you should get something that matches the default view and lightning pretty closely:  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/add-a-light-5.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-camera-1.png" loading="lazy">

Next, click this little arrow next to the axis cross thing:  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-camera-2.png" loading="lazy">

A menu should pop up. Open the View tab and check the Lock Camera to View box.  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-camera-3.png" loading="lazy">

Next, select a camera that should already be placed somewhere in your project. It should look like this:  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-camera-4.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/set-up-a-camera-5.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/configure-and-render-1.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/configure-and-render-2.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/configure-and-render-3.png" loading="lazy">
...
<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/configure-and-render-4.png" loading="lazy">

And there you have it! You have made yourself a model and render that is usable in Minecraft: Dungeons!  

<img class="center" src="asdfasdf/images/pages/dungeons/items-tutorial/configure-and-render-5.png" loading="lazy">
